...
- **Docfillyを組み込む開発者** — [APIリファレンス](./04-api-reference.md)、[セキュリティと制約](./07-security-and-limitations.md)
...
開発サーバーのURLをブラウザで開き、`.md`、`.markdown`、または`.txt`ファイルを選択します。ファイルを選択する前にもサンプル文書が表示されるため、フォーム入力によって本文が変わる体験を確認できます。

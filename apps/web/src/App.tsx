      ...
      {openDialog === "help" && (
        ...
        >
          <section>
            <h3>Docfillyとは？</h3>
            <p>
              手順書には、プロジェクト名や実行環境など、読む人が自分の状況に合わせて読み替える箇所があります。Docfillyでは、書き手があらかじめDocfilly形式に沿って、入力項目や条件分岐をMarkdown／テキスト文書へ記述します。読み手がその文書を開くと、書き手の設定に基づくフォームが表示されます。自分の環境に合った値を入力することで、置き換え作業ではなく、手順の内容そのものに集中できます。通常のMarkdown／テキスト文書もそのまま表示できます。
            </p>
          </section>
          <section>
            <h3>文書を開く</h3>
